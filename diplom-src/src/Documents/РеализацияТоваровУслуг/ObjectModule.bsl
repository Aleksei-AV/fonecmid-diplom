...
//a.avdyushin 11.2023 Процедура ВыполнитьАвтозаполнение документа договор на обслуживание
Процедура ВыполнитьАвтозаполнение() Экспорт
	...
	Если ЗначениеЗаполнено(КонстатнаРаботы) И 
		...
		Если ТекущийДоговор.ВКМ_СуммаАбонентскойПлаты > 0 Тогда
			
			СтрокаУслугиОбслуживание = ЭтотОбъект.Услуги.Добавить();
			СтрокаУслугиОбслуживание.Номенклатура = КонстантаАбонентскаяПлата; 
			СтрокаУслугиОбслуживание.Количество = 1;
			СтрокаУслугиОбслуживание.Цена = ТекущийДоговор.ВКМ_СуммаАбонентскойПлаты;
			СтрокаУслугиОбслуживание.Сумма = ТекущийДоговор.ВКМ_СуммаАбонентскойПлаты;
			...
			Запрос.УстановитьПараметр("Договор", ТекущийДоговор.Наименование);
			...
			Если Выборка.Количество() <> 0 Тогда
				...
				СтрокаУслугиРаботы = ЭтотОбъект.Услуги.Добавить();
...
// a.avdyushin 11.2023 Изменение в обработке проверки заполнения, т.к. для договоров с абонентским обслуживанием "Основание" неопределенно и поле не является обязательным.
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Запрос.УстановитьПараметр("Ссылка", Ссылка.Договор);
...
//a.avdyushin 11.2023 Конец Процедуры
