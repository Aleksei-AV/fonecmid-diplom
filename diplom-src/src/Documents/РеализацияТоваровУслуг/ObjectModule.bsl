...
Процедура ВКМ_ВыполнитьАвтозаполнение(Договор, ДатаСозданияНовойРеализации) Экспорт
	...
	Если ЗначениеЗаполнено(КонстатнаРаботы) И 
		...
		Если Договор.ВКМ_СуммаАбонентскойПлаты > 0 Тогда
			...
			ДатаНачала = НачалоМесяца(ДатаСозданияНовойРеализации);
			Запрос.УстановитьПараметр("ДатаНачала", ДатаНачала);
			ДатаОкончания = КонецМесяца(ДатаСозданияНовойРеализации);
